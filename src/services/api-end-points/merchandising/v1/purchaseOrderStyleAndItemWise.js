...
export const PURCHASE_ORDER_STYLE_AND_ITEM_WIESE_API = {
  ...
  //For RDLC Report
  fetch_po_style_by_so_id_rdlc: ( authUserId, supplierOrderId ) => `Reports/Merchandising/${authUserId}/${supplierOrderId}/PurchaseOrderStyleWise`,
  fetch_po_style_and_po_wise_by_so_id_rdlc: ( authUserId, supplierOrderId ) => `Reports/Merchandising/${authUserId}/${supplierOrderId}/PurchaseOrderPOWise`
