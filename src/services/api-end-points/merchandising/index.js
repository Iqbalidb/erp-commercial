export const merchandisingApi = {
    ...
    setCosting: {
        root: `/api/merchandising/setCostings`
    },
    consumption: {
    ...
    setConsumption: {
        root: `/api/merchandising/setConsumptions`
    },
    season: {
    ...
    setStyle: {
        ...
        get_setStyles: `/api/set-pack/get-all`,
    ...
    exportPi: {
        root: `/api/merchandising/exportPI`
    },
    exportPIs: {
        root: `/api/merchandising/exportPIs`
    }
};
