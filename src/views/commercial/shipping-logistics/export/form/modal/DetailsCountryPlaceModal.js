...
import { bindExportScheduleDetails } from "views/commercial/shipping-logistics/store/actions";
            ...
            >
                ...
                <DataTable
                    conditionalRowStyles={[
                        {
                            when: row => ( single ? row.value === exportScheduleDetails[whichForTheModal]?.value ?? '' : exportScheduleDetails[whichForTheModal]?.find( p => p.label === row.label )?.label === row.label ?? '' ),
                            style: {
