...
import { edfFileDelete, edfFileUpload } from "../../store/actions";

const EDFDocument = ( { isDetailsForm = false } ) => {
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( edfFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
