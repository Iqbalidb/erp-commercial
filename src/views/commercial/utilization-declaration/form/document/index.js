...
import { udFileDelete, udFileUpload } from "../../store/actions";
const UdDocument = ( { fromDetails = false, isDetailsForm = false, isAmendmentDetailsForm = false } ) => {
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( udFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
    ...
    return (
        <>
            <Col>
                {
                    isDetailsForm || isAmendmentDetailsForm ? (
