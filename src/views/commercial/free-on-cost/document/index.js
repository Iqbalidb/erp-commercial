...
import { focFileDelete, focFileUpload } from "../store/actions";

const FocDocument = ( { isDetailsForm = false } ) => {
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( focFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
