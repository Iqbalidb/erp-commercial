...
import { docSubmissionFileDelete, docSubmissionFileUpload } from "../../store/actions";

const DocSubDocument = ( { isDetailsForm = false } ) => {
    ...
    const { files, fileUrls } = documentSubInfo;
    ...
    const handleAddFileToTable = () => {
        ...
        dispatch( docSubmissionFileUpload( obj ) );
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( docSubmissionFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
