...
const LoadingPortAndDischargeModal = ( props ) => {
    ...
    useEffect( () => {
        setCountries( generalImportInfo[whichForTheModal] );
        return () => {
            setCountries( [] );
        };
    }, [] );
            ...
            >
                ...
                <DataTable
                    ...
                    conditionalRowStyles={[
                        {
                            when: row => countries?.some( pt => pt.id === row.id ),
                            style: {
...
export default LoadingPortAndDischargeModal;