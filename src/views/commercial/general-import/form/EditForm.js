...
import { bindGeneralImportInfo, editGeneralImport, getGeneralImportById, getGeneralImportUsedPI } from "../store/actions";
...
const EditForm = () => {
    ...
    const onSubmit = () => {
        ...
        dispatch( editGeneralImport( submitObj, id ) );
    };
    const onDraft = () => {
        ...
        dispatch( editGeneralImport( draftSubmitObj, id ) );

    };

    return (
        <>
            <ActionMenu breadcrumb={breadcrumb} title='General Import : Edit' >
