...
import { exportInvoiceFileDelete, exportInvoiceFileUpload } from "../../store/actions";

const ExportInvoiceDocument = ( { isDetailsForm = false } ) => {
    ...
    const { files, fileUrls } = exportInvoiceInfo;
    ...
    const handleAddFileToTable = () => {
        ...
        dispatch( exportInvoiceFileUpload( obj ) );
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( exportInvoiceFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
...
export default ExportInvoiceDocument;