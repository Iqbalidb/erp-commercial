...
import { backToBackDocFileUpload, backToBackFileDelete } from "../../store/actions";
...
export default function BackToBackDocument( { fromDetails = false, isDetailsForm = false } ) {
    ...
    const { files, fileUrls } = backToBackInfo;
    ...
    const handleAddFileToTable = () => {
        ...
        dispatch( backToBackDocFileUpload( obj ) );
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( backToBackFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
