...
import { bindMasterDocumentInfo, getExportPiBuyerPo } from '../../store/actions';
export default function OpeningBanks( props ) {
    const { openModal, setOpenModal, whichForTheModal, setWhichForTheModal, setModalExportPI } = props;
