...
export default function BeneficiaryBankModal( props ) {
    const { openModal, setOpenModal, handleDropDownChange, selectedBank } = props;
    ...
    const handleRow = ( row ) => {
        ...
        handleDropDownChange( { label, value }, { name: 'bank' } );
        setOpenModal();
    };
            ...
            <UILoader
                ...
                <DataTable
                    conditionalRowStyles={[
                        {
                            when: row => row.value === selectedBank?.value.toLowerCase().trim() ?? '',
                            style: {
