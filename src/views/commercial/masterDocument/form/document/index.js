...
import { masterDocFileDelete, masterDocFileUpload } from '../../store/actions';
...
export default function Document( { fromDetails = false } ) {
    ...
    const { files, fileUrls } = masterDocumentInfo;
    ...
    const handleAddFileToTable = () => {
        ...
        dispatch( masterDocFileUpload( obj ) );
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( masterDocFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
            ...
            }
            {
                !fromDetails && (
                    <FormContentLayout title='Document' >
                        <>
                            <Col lg='5'>
                                <div className=' w-100  file-upload-container d-flex align-items-center '>
