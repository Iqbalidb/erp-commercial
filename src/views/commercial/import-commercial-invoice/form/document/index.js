...
import { importInvoiceFileDelete, importInvoiceFileUpload } from "../../store/actions";
const CommercialInvoiceDocument = ( { isDetailsForm = false } ) => {
    ...
    const { files, fileUrls } = commercialInvoiceInfo;
    ...
    const handleAddFileToTable = () => {
        ...
        dispatch( importInvoiceFileUpload( obj ) );
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( importInvoiceFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
