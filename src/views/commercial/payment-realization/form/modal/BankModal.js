...
import { bindPaymentRealizationInfo, bindRealizationInstructions } from "../../store/actions";
...
const BankModal = ( props ) => {
    ...
    const handleRow = ( row ) => {
        ...
        dispatch( bindPaymentRealizationInfo( updatedInfo ) );
            ...
            <UILoader
                ...
                <DataTable
                    conditionalRowStyles={[
                        {
                            when: row => row.value === paymentRealizationInfo[whichForTheModal]?.value.toLowerCase().trim() ?? '',
                            style: {
