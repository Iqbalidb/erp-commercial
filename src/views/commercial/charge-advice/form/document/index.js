...
import { chargeAdviceFileDelete, chargeAdviceFileUpload } from "../../store/actions";
...
const ChargeAdviceDocument = ( { isDetailsForm = false } ) => {
    ...
    const { files, fileUrls } = chargeAdviceInfo;
    ...
    const handleAddFileToTable = () => {
        ...
        dispatch( chargeAdviceFileUpload( obj ) );
    ...
    const handleFileRemoveFromTable = file => {
        confirmDialog( confirmObj ).then( async e => {
            if ( e.isConfirmed ) {
                ...
                dispatch( chargeAdviceFileDelete( file, handleDeleteProgress ) );
            }
        } );
    };
...
export default ChargeAdviceDocument;