...
import ResizableTable from './Resize';
import TH from './custom-table-widgets/TH';
import Pagination from './custom-table-widgets/pagination';
import './table.scss';
...
export default function CustomTable( props ) {
    ...
    return (
        <>
                        ...
                        {data.length ? dataSlice?.map( ( column, index ) => (
                            <Fragment key={column.rowId}>
                                <tr>
                                    ...
                                    >
                                        {expandIcon ? expandIcon : column.expanded ? <span style={{ fontSize: '1.5rem' }}>&#8722;</span> : <span style={{ fontSize: '1.5rem' }}>&#43;</span>}
                                    </td>}
                                    {
                                        mergedColumns?.map( ( c, indx ) => (
                                            <Fragment key={c.id}>
            ...
            {/* {!paginationServer && !!data.length ? <ReactPaginate
                previousLabel={'Pre'}
                nextLabel={'Next'}
                ...
                containerClassName={
                    'pagination react-paginate justify-content-end mb-0 mt-2'
                }
            /> : null} */}
